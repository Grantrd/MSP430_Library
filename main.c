...
void main(void)
     {
        ...
        //Read_ADC_Volts(1.4, 12, 3.0);                       //prints ADC value in volts(pinNum, resolution, voltage)
        //printer(ADC_Bits(1.4, 12, 0.8));                   //returns ADC value in bits()
        //printer(ADC_Volts(1.4, 12, 0.8));                 //returns ADC value in volts()
        Custom_Read_ADC_Volts(1.4, 12, 3.3, 2.0);        //prints ADC value in volts with custom min voltage(pinNum, resolution, voltage, min)
